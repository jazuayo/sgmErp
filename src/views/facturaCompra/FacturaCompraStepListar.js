...
export default function FacturaCompraStepListar() {
  ...
  const seleccionarRegistro = (selectedRow) => {
    ...
    setRegistro({
      ...
      autorizacionFecha: selectedRow.autorizacionFecha.split("T")[0], //date
      ...
      fechaEmite: selectedRow.fechaEmite.split("T")[0], //date
      ...
      siglasProveedor: selectedRow.persona.siglasProveedor,
      llevaIva: selectedRow.persona.personaTipo.ivaCompra,
      // LISTAS
